...
export class SymbolsStorage {
  ...
  public resolveSymbol(
    ...
    return this._readyPromise.then(() => {
      const symbolInfo =
        this._symbolsInfo[symbolWithCurrencyKey(symbolName, currencyCode)];
    ...
    try {
      ...
      for (; symbolIndex < symbolsCount; ++symbolIndex) {
        ...
        if (currencyCode !== undefined) {
          this._symbolsInfo[symbolWithCurrencyKey(ticker, currencyCode)] =
            symbolInfo;
          this._symbolsInfo[symbolWithCurrencyKey(symbolName, currencyCode)] =
            symbolInfo;
          this._symbolsInfo[symbolWithCurrencyKey(fullName, currencyCode)] =
            symbolInfo;
        }
